...
# create cursor object
    ...
    if motion_detected and motion_frames > 10 : 
        dir = os.listdir("/home/pi/Pictures/LoRaComm_Imgs")             #change the directory path to the dir where pictures are stored after capture 
        ...
        try:
            for d in dir:
                ...
                if xx > x_old:
                    xt = xx + 1
                    x_old = xx
            file_name = "/home/pi/Pictures/LoRaComm_Imgs/" + "image_" + str(xt) + ".jpg"           #change the directory path to the dir where pictures are stored after capture 
            print(file_name)
        except:
            file_name = "/home/pi/Pictures/LoRaComm_Imgs/image_1.jpg"                          #change the directory path to the dir where pictures are stored after capture 
# Save the current frame as a photo
    ...
    if t != prev_time:
        ...
        try:
            ...
            file_name = "/home/pi/Pictures/LoRaComm_Imgs/image_1.jpg"
