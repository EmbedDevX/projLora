...
logging.basicConfig(filename='/home/Darterone/Lora/AmanLoraProj/items.log')
...
def transmitF(filepath):
    ...
    #    print("Transmit time: {0:0.2f} ms | Data rate: {1:0.2f} byte/s".format(LoRa.transmitTime(), LoRa.dataRate()))
        ...
        if a == 217 and b == 255 :
            ...
            print("End of jpg img")
            with open('/home/Darterone/Lora/AmanLoraProj/items.log', 'a') as log_file:
