...
logging.basicConfig(filename='/home/Darterone/items.log')
logger = logging.getLogger()
logger.setLevel(logging.DEBUG)

image_dir = "/home/Darterone/Pictures/LoRaComm_Imgs/"
output_file=''
...
#        print("Transmit time: {0:0.2f} ms | Data rate: {1:0.2f} byte/s".format(LoRa.transmitTime(), LoRa.dataRate()))
        ...
        if a == 217 and b == 255 :
            ...
            print("End of jpg img")
            with open('/home/Darterone/AmanLoraProj/items.log', 'a') as log_file:
...
def recF():
    ...
    while True:
        try:
            img_index = len(os.listdir("/home/Darterone/Pictures/LoRaComm_Imgs/"))
            img_index += 1
        except:
            img_index = 0
        ...
        if  LoRa.available() < 1 :
            im_dir = "/home/Darterone/Pictures/LoRaComm_Imgs/"
            cur_ls = os.listdir(im_dir)

            with open('/home/Darterone/AmanLoraProj/items.log', 'r') as log_file:
...
while True:
    ...
    if new_files:
        for file in new_files:
            ...
            transmitF(file_path)
            con = sqlite3.connect('/var/www/WebApplication/instance/logs2.db')    #change the file path of the path where "data.db is present"
